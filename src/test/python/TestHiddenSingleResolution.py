...
class TestHiddenSingleResolution(unittest.TestCase):
    ...
    def test_horizontal_hidden_single_in_a_block(self):
        ...
        self.assertEqual(1, self.hiddenSingleResolution.block_hidden_single(grid, 4, 1))
        self.assertEqual(0, self.hiddenSingleResolution.block_hidden_single(grid, 0, 3))
