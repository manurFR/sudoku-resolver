...
class TestLockedCandidatesResolution(unittest.TestCase):
    ...
    def test_horizontal_line_box_reduction(self):
        ...
        self.assertEqual(1, self.lockedCandidatesResolution.horizontal_line_box_reduction(grid, 6, 0))
    ...
    def test_vertical_line_box_reduction(self):
        ...
        self.assertEqual(0, self.lockedCandidatesResolution.vertical_line_box_reduction(grid, 3, 0))
